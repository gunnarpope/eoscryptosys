...
class [[eosio::contract]] eoscryptosys : public eosio::contract {

public:
  using contract::contract;


  eoscryptosys(name receiver, name code,  datastream<const char*> ds): contract(receiver, code, ds) {}
...
EOSIO_DISPATCH( eoscryptosys, (certify)(erase))
